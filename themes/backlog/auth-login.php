    ...
    <div class="auth_content container content">
        ...
        <form class="auth_form" action="<?= url('/entrar'); ?>" method="post" enctype="multipart/form-data">
            ...
            <label>
                ...
                <input required type="email" value="<?= ($cookie ?? null); ?>" name="email" placeholder="Informe seu e-mail:"/>
            </label>
            ...
            <label>
                ...
                <input  value="<?= ($cookie ?? null); ?>" required type="password" name="password" placeholder="Informe sua senha:"/>
            </label>

            <label class="check">
                <input type="checkbox" value="<?= (!empty($cookie)) ? "checked" : ""; ?>" name="save"/>
