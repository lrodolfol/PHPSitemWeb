...
<h1><a class="icon-coffee transition" title="Home" href="<?= url(); ?>">Cafe<b>Controls</b></a>

  <?= $v->section("sub-titulo"); ?>
        ...
        <nav class="main_header_nav">
            ...
            <div class="main_header_nav_links j_menu_mobile_tab">
                ...
                <a class="link transition radius" title="Teste" href="<?= url("test"); ?>">Teste</a>
                <a class="link transition radius" title="Teste II" href="<?= url("testTwo"); ?>">Teste II</a>
